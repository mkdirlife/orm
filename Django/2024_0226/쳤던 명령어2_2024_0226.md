...
# ... 생략 ...
# @login_required 이것만 해주면 로그인 사용자들만 삭제할 수 있다.
# @login_required
def blog_delete(request, pk):
...
<p style="color:red;">{{ error }}</p>
# enctype="multipart/form-data" 가 있어야만 FILES를 전송할 수 있다.
...
################################
# 수정하기 버튼 추가
# blog > templates > blog_details.html
